...
### 4.3. Обхождания (Ойлер и Хамилтон)
...
### 5.2. Функции на една променлива ($n=1$)
...
### 5.2. Функции на две променливи ($n=2$)
...
### 5.3. Закони на Булевата алгебра
...
### 5.5. Пълни множества от булеви функции
...
### 5.12. Пълнота и Шеферови функции
